...
public class SecurityConfig {
    ...
    @Bean
    public UserDetailsService userDetailsServeice(){
        
        UserDetails rodolpho = User.builder().username("rodolpho").password(passwordEncoder().encode("123456")).roles("USER").build();
